      ...
      <main id="main" className="mx-auto max-w-[1040px] px-6 pb-24 pt-16 md:px-10">
        <section id="home" className="grid gap-12 border-b border-line pb-16 md:grid-cols-[1.35fr_0.9fr] md:gap-16 md:pb-20">
          <div>
            ...
            <h1 className="mt-0 mb-6 font-sans text-[clamp(2.5rem,5vw,3.75rem)] font-normal leading-[1.18] tracking-[-0.02em]">
              {t.heroTitle}
            </h1>
          ...
          <aside className="self-end border-t border-line pt-6 md:border-t-0 md:border-l md:pl-10 md:pt-0">
            <p className="m-0 font-sans text-[1.7rem] leading-tight">Pradip Puri</p>
        ...
        <section id="profile" className="mt-20 grid gap-10 md:grid-cols-[9rem_1fr] md:gap-14">
          ...
          <article>
            <p className="mt-0 font-sans text-[1.5rem] leading-snug">{t.profileHeadline}</p>
            <p className="text-muted">{t.profileP1}</p>
            <p className="text-muted">{t.profileP2}</p>

            <h3 className="mb-4 mt-12 font-sans text-[1.4rem] font-normal">{t.positionTitle}</h3>
            ...
            <h3 className="mb-4 mt-12 font-sans text-[1.4rem] font-normal">{t.expertiseTitle}</h3>
            ...
            <h3 className="mb-4 mt-12 font-sans text-[1.4rem] font-normal">{t.experienceTitle}</h3>
            ...
            <h3 className="mb-4 mt-12 font-sans text-[1.4rem] font-normal">{t.certsTitle}</h3>
            ...
            <h3 className="mb-4 mt-12 font-sans text-[1.4rem] font-normal">{t.educationTitle}</h3>
            <ul className="m-0 list-none p-0">
              {t.education.map((edu) => (
          ...
          <div>
            ...
            <ol className="m-0 mt-10 list-none p-0">
              {t.services.map((service, i) => (
                ...
                >
                  <span className="font-sans text-muted">0{i + 1}</span>
                  <h3 className="m-0 font-sans text-[1.4rem] font-normal leading-snug">{service.title}</h3>
